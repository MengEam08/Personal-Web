    ...
    <>
      ...
      <section className="py-14 lg:py-24 relative">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            <div
              className="lg:pr-[100px] flex items-center"
              data-aos="fade-up"
              data-aos-duration="1500"
            >
      ...
      <div className="mt-10 flex  flex-col justify-center w-max gap-20 mx-auto">
        ...
        <div className="mt-10 grid justify-center selection  sm:px-4 gap-20 md:gap-20 lg:gap-40  sm:grid-cols-2">
          {/* Mentor 1 */}
          <div
            className="w-[300px] text-center py-4 px-6 bg-[#16A1DF] shadow-sm rounded-xl transform transition-all duration-300 hover:scale-105 hover:shadow-sm"
            data-aos="fade-up"
            data-aos-duration="1500"
          >
      ...
      <div className="flex flex-col justify-center mt-14 w-max mx-auto">
        <h1
          className="text-center text-3xl p-3 text-[#0056B1] font-bold sm:text-4xl font-suwannaphum"
          data-aos="fade-up"
        ...
        <div className="mt-10 grid justify-center items-center lg:gap-40 md:gap-20 gap-20 sm:grid-cols-2 lg:grid-cols-3">
          ...
          >
            ...
            <ul className="flex justify-center  mt-2">
              <li>
                <a
                  href="https://www.facebook.com/profile.php?id=100028119094073&mibextid=LQQJ4d"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xl text-white hover:text-red-600 "
                >
          ...
          >
            ...
            <ul className="flex justify-center  mt-2">
              <li>
                <a
                  href="https://www.facebook.com/profile.php?id=100053897863470&mibextid=ZbWKwL"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xl text-white hover:text-red-600 "
                >
              ...
              <li>
                <a
                  href="https://github.com/Channarith_Pon"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xl text-white hover:text-red-600"
                >
          ...
          >
            ...
            <ul className="flex justify-center  mt-2">
              <li>
                <a
                  href="https://www.facebook.com/HongSreyneang.2004?mibextid=JRoKGi"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xl text-white hover:text-red-600 "
                >
              ...
              <li>
                <a
                  href="https://github.com/SREYNEANG-HONG"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xl text-white hover:text-red-600"
                >
              ...
              <li>
                <a
                  href="https://t.me/SREYNEANG_HONG"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xl text-white hover:text-red-600"
                >
          ...
          >
            ...
            <ul className="flex justify-center  mt-2">
              <li>
                <a
                  href="https://www.facebook.com/van.sok.980?mibextid=ZbWKwL"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xl text-white hover:text-red-600 "
                >
              ...
              <li>
                <a
                  href="https://github.com/VanSok55"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xl text-white hover:text-red-600"
                >
          ...
          >
            ...
            <ul className="flex justify-center  mt-2">
              <li>
                <a
                  href="https://www.facebook.com/ka.nika.7737769?mibextid=ZbWKwL"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xl text-white hover:text-red-600 "
                >
          ...
          >
            ...
            <ul className="flex justify-center  mt-2">
              <li>
                <a
                  href="https://www.facebook.com/nam.ponleu?mibextid=LQQJ4d"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xl text-white hover:text-red-600 "
                >
              ...
              <li>
                <a
                  href="https://github.com/namponleu"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xl text-white hover:text-red-600"
                >
          ...
          >
            ...
            <ul className="flex justify-center  mt-2">
              <li>
                <a
                  href="https://www.facebook.com/mengeam.seng?mibextid=ZbWKwL"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xl text-white hover:text-red-600 "
                >
          ...
          >
            ...
            <ul className="flex justify-center  mt-2">
              <li>
                <a
                  href="https://www.facebook.com/Boen.thi.monster?mibextid=ZbWKwL"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xl text-white hover:text-red-600 "
                >
          ...
          >
            ...
            <ul className="flex justify-center  mt-2">
              ...
              <li>
                <a
                  href="https://github.com/PochPisethh"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xl text-white hover:text-red-600"
                >
              ...
              <li>
                <a
                  href="http://t.me/Zwcodecambodia168"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xl text-white hover:text-red-600"
                >
